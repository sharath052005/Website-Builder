    ...
    <>
      ...
      max-md:px-4 min-h-[80vh]'>
        <div className='text-center mt-16'>
          ...
          font-medium'> Choose Your Plan </h2>
          <p className='text-gray-400 text-sm max-w-md
          mx-auto -mt-20'>
            Start for free and scale up as you grow.
            Find the perfect plan for your Website creation needs.
          </p>
        </div>
      ...
      <p className='mx-auto text-center text-sm max-w-md mt-10 text-white/60
         font-light'>Project <span className='text-white'>Creation / Revision</span> consume <span className='text-white'>5
        credits</span>. You can purchase more credits to create 
        more projects.</p>
      </div>
      <Footer />
    </>
